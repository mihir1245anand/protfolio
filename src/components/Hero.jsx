        ...
        <div className="hero-visual fade-in-element visible">
          <div className="hero-code-card">
            ...
            <div className="code-card-body">
              ...
              <div className="code-line"><span className="line-num">6</span><span className="line-content">&nbsp;&nbsp;<span className="prop">dsaProblems</span>: <span className="num">325</span>,</span></div>
              <div className="code-line"><span className="line-num">7</span><span className="line-content">&nbsp;&nbsp;<span className="prop">codechefSolved</span>: <span className="num">268</span>,</span></div>
              <div className="code-line"><span className="line-num">8</span><span className="line-content">&nbsp;&nbsp;<span className="prop">leetcodeSolved</span>: <span className="num">57</span>,</span></div>
